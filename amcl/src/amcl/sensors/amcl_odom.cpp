...
void AMCLOdom::SetModelDiff(double alpha1, double alpha2,
...
void AMCLOdom::SetModelOmni(double alpha1, double alpha2,
...
void AMCLOdom::SetModel( odom_model_t type, double alpha1,
    double alpha2, double alpha3, double alpha4, double alpha5 ) {
